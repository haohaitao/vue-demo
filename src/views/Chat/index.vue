<template>
  <div style="min-width: 1050px;margin-bottom: 30px;">
    <blockquote style="margin-top: 100px;text-align: center;">
      ...
      <p>
          <el-input placeholder="输入一个昵称" v-model="username" style="width: 280px;">
            <template slot="prepend">昵称</template>
          </el-input>
        <el-button type="success" v-if="disabled" :disabled="!disabled" @click="btnLink">连接</el-button>
        <el-button type="danger" v-if="!disabled" :disabled="disabled" @click="closeBtn">断开</el-button>
      </p>
      <small>
